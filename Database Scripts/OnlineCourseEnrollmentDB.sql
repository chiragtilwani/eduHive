...
CREATE TABLE UserRole (
    ...
    CONSTRAINT FK_UserRole_UserProfile FOREIGN KEY (UserId) REFERENCES UserProfile(UserId) ON DELETE CASCADE,
    CONSTRAINT FK_UserRole_Roles FOREIGN KEY (RoleId) REFERENCES Roles(RoleId) ON DELETE CASCADE,
	CONSTRAINT FK_UserRole_SmartApp FOREIGN KEY (SmartAppId) REFERENCES SmartApp(SmartAppId) ON DELETE CASCADE
);
...
CREATE TABLE Instructor (
	...
	CONSTRAINT FK_Instructor_UserProfile FOREIGN KEY (UserId) REFERENCES UserProfile(UserId) ON DELETE CASCADE
);
...
CREATE TABLE Course (
    ...
    CONSTRAINT FK_Course_CourseCategory FOREIGN KEY (CategoryId) REFERENCES CourseCategory(CategoryId) ON DELETE NO ACTION, -- THIS WILL PREVENT DELETION OF A CATEGORY IF COURSES ARE ASSOCIATED WITH IT
    CONSTRAINT FK_Course_Instructor FOREIGN KEY (InstructorId) REFERENCES Instructor(InstructorId) ON DELETE NO ACTION -- THIS WILL PREVENT DELETION OF AN INSTRUCTOR IF COURSES ARE ASSOCIATED WITH IT (RECOMMENDATION IS TO USE "ON DELETE SET NULL" BUT InstructorId OF THIS TABLE HAS CONSTRAINT NOT NULL)
);
...
CREATE TABLE SessionDetails (
    ...
    CONSTRAINT FK_SessionDetails_Course FOREIGN KEY (CourseId) REFERENCES Course(CourseId) ON DELETE CASCADE
);
...
CREATE TABLE Enrollment (
    ...
    CONSTRAINT FK_Enrollment_Course FOREIGN KEY (CourseId) REFERENCES Course(CourseId) ON DELETE NO ACTION, -- THIS WILL PREVENT DELETION OF A COURSE IF ENROLLMENTS ARE ASSOCIATED WITH IT (RECOMMENDATION IS TO USE "ON DELETE SET NULL" BUT CourseId OF THIS TABLE HAS CONSTRAINT NOT NULL)
    CONSTRAINT FK_Enrollment_UserProfile FOREIGN KEY (UserId) REFERENCES UserProfile(UserId) ON DELETE CASCADE
);
...
CREATE TABLE Payment (
    ...
    CONSTRAINT FK_Payment_Enrollment FOREIGN KEY (EnrollmentId) REFERENCES Enrollment(EnrollmentId) ON DELETE CASCADE
);
...
CREATE TABLE Review (
    ...
    CONSTRAINT FK_Review_UserProfile FOREIGN KEY (UserId) REFERENCES UserProfile(UserId) ON DELETE CASCADE -- RECOMMENDATION IS TO USE "ON DELETE SET NULL" BUT UserId OF THIS TABLE HAS CONSTRAINT NOT NULL
);
